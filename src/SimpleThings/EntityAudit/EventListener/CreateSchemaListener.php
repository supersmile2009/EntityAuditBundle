...
class CreateSchemaListener implements EventSubscriber
{
    ...
    public function postGenerateSchemaTable(GenerateSchemaTableEventArgs $eventArgs)
    {
        ...
        foreach ($entityTable->getColumns() as $column) {
            ...
            // These 2 options throw deprecation notice and will throw error in next version of Doctrine
            // Name can only be set through constructor
            // Version has to be set through platformOptions, but it needed in a revision table anyway
